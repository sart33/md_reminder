...
class GetReminderMenuListUseCase(private val reminderMenuRepository: ReminderMenuRepository) {

    operator fun invoke(): LiveData<List<ReminderMenuItem>> {
        return reminderMenuRepository.getReminderMenuList()
    }
}