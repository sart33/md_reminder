 ...
 */
class ReminderCalendarWidget : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        if (intent?.action == "android.appwidget.action.APPWIDGET_UPDATE") {
            ...
            val appWidgetIds = appWidgetManager.getAppWidgetIds(
                ComponentName(context!!, ReminderCalendarWidget::class.java)
            )
    ...
    companion object {
        ...
        const val EVENT_DATE =
            "solutions.mobiledev.reminder.presentation.widget.calendar.EVENT_DATE"
        ...
        fun updateWidget(
            ...
            val intent = Intent(context, ReminderCalendarWidgetService::class.java)
            intent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, sp.widgetId)
            intent.data = Uri.parse(intent.toUri(Intent.URI_INTENT_SCHEME))
            val cal = GregorianCalendar()
            cal.timeInMillis = System.currentTimeMillis()

            val prefsProvider = CalendarWidgetPrefsProvider(context, sp.widgetId)
            val month = prefsProvider.getMonth()
            val year = prefsProvider.getYear()

            val headerBgColor = sp.getHeaderBackground()
            val bgColor = sp.getBackground()
            val views = RemoteViews(context.packageName, R.layout.reminder_calendar_widget)
            ...
            val startActivityIntent = Intent(context, CalendarActionReceiver::class.java)
